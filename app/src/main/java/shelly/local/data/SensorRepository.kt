...
import shelly.local.data.api.OpenSenseMapClient
import shelly.local.data.api.InstalledOsmScript
import shelly.local.data.api.OsmBox
import shelly.local.data.api.OsmScript
import shelly.local.data.api.PlugArchiveClient
import shelly.local.data.api.ScriptDeployer
import shelly.local.data.api.valueFor
import shelly.local.data.api.ShellyClientFactory
import shelly.local.model.Device
import shelly.local.data.db.SensorBlockDao
import shelly.local.model.SensorBlock
import shelly.local.model.SensorHistory
